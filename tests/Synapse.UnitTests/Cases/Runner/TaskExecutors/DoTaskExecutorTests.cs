    ...
    : RunnerTestsBase
{
    ...
    public async Task Execute_Should_Work()
    {
        ...
        var executor = ActivatorUtilities.CreateInstance<DoTaskExecutor>(this.ServiceProvider, context);
    ...
    public async Task Execute_Until_Exit_Directive_Should_Work()
    {
        ...
        var green = "green";
        var blue = "blue";
        var definition = new DoTaskDefinition()
        {
            Do =
            [
                new("red", new SetTaskDefinition()
        ...
        var executor = ActivatorUtilities.CreateInstance<DoTaskExecutor>(ServiceProvider, context);
