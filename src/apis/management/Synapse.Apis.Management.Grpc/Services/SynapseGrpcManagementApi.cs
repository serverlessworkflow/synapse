    ...
    : ISynapseGrpcManagementApi
{
    ...
    /// <inheritdoc/>
    public virtual async Task<GrpcApiResult<V1Correlation>> CreateCorrelationAsync(V1CreateCorrelationCommand command, CallContext context = default)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<GrpcApiResult> DeleteCorrelationContextAsync(V1DeleteCorrelationContextCommand command, CallContext context = default)
    {
        if (command == null) throw new ArgumentNullException(nameof(command));
        return GrpcApiResult.CreateFor(await this.Mediator.ExecuteAsync(this.Mapper.Map<Application.Commands.Correlations.V1DeleteCorrelationContextCommand>(command), context.CancellationToken));
    }

    /// <inheritdoc/>
    public virtual async Task<GrpcApiResult> DeleteCorrelationContextEventAsync(V1DeleteCorrelatedEventCommand command, CallContext context = default)
    {
        if (command == null) throw new ArgumentNullException(nameof(command));
        return GrpcApiResult.CreateFor(await this.Mediator.ExecuteAsync(this.Mapper.Map<Application.Commands.Correlations.V1DeleteCorrelatedEventCommand>(command), context.CancellationToken));
    }
