...
public interface ISynapseGrpcManagementApi
{
    ...
    /// <returns>A new object that describes the result of the operation</returns>
    [OperationContract]
    Task<GrpcApiResult<List<V1Correlation>>> GetCorrelationsAsync(string? query = null, CallContext context = default);
    ...
    [OperationContract]
    Task<GrpcApiResult> DeleteCorrelationContextAsync(V1DeleteCorrelationContextCommand command, CallContext context = default);
    ...
    /// <returns>A new awaitable <see cref="Task"/></returns>
    [OperationContract]
    Task<GrpcApiResult> DeleteCorrelationContextEventAsync(V1DeleteCorrelatedEventCommand command, CallContext context = default);
