...
namespace Synapse.Runner.Application.Services.Processors
{
        ...
        where TState : StateDefinition
    {
        ...
        protected StateProcessor(ILoggerFactory loggerFactory, IWorkflowExecutionContext executionContext, IWorkflowActivityProcessorFactory activityProcessorFactory, IOptions<ApplicationOptions> options, V1WorkflowActivity activity, TState state) 
