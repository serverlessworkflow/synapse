...
namespace Synapse.Runner.Application.Services.Processors
{
        ...
        : StateProcessor<InjectStateDefinition>
    {
        ...
        public InjectStateProcessor(ILoggerFactory loggerFactory, IWorkflowExecutionContext executionContext, IWorkflowActivityProcessorFactory activityProcessorFactory, V1WorkflowActivity activity, InjectStateDefinition state)
