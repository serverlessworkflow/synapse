...
namespace Synapse.Runner.Application.Services.Processors
{
        ...
        : WorkflowActivityProcessor
    {
        ...
        protected ActionProcessor(ILoggerFactory loggerFactory, IWorkflowExecutionContext executionContext, IWorkflowActivityProcessorFactory activityProcessorFactory, V1WorkflowActivity activity, ActionDefinition action) 
