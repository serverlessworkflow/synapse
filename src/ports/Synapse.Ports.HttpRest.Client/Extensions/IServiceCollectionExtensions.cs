...
using Synapse.Ports.HttpRest.Client.Services;
...
namespace Synapse
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        {
            services.AddHttpClient(typeof(SynapseRestApiClient).Name, http => httpClientSetup(http));
            services.TryAddSingleton<ISynapseApi, SynapseRestApiClient>();
            return services;
        }
