...
namespace Synapse.Integration.Events.WorkflowInstances
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the execution of a V1WorkflowInstance has started
	/// </summary>
	[DataContract]
	public partial class V1WorkflowInstanceStartedIntegrationEvent
		: V1IntegrationEvent
	{
