...
namespace Synapse.Integration.Events.WorkflowInstances
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the execution of a V1WorkflowInstance is starting
	/// </summary>
	[DataContract]
	public partial class V1WorkflowInstanceStartingIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The string used to uniquely identify the V1WorkflowInstance's process
		/// </summary>
		[DataMember(Name = "ProcessId", Order = 3)]
		[Description("The string used to uniquely identify the V1WorkflowInstance's process")]
