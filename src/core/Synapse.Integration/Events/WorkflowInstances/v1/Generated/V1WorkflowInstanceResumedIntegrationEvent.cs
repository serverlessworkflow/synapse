...
namespace Synapse.Integration.Events.WorkflowInstances
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the execution of a V1WorkflowInstance has been resumed
	/// </summary>
	[DataContract]
	public partial class V1WorkflowInstanceResumedIntegrationEvent
		: V1IntegrationEvent
	{
