...
namespace Synapse.Integration.Events.WorkflowInstances
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the execution of a V1WorkflowInstance is being cancelled
	/// </summary>
	[DataContract]
	public partial class V1WorkflowInstanceCancellingIntegrationEvent
		: V1IntegrationEvent
	{
