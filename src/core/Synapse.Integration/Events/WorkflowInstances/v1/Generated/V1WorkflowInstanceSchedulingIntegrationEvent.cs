...
namespace Synapse.Integration.Events.WorkflowInstances
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the execution of a V1WorkflowInstance is being scheduled
	/// </summary>
	[DataContract]
	public partial class V1WorkflowInstanceSchedulingIntegrationEvent
		: V1IntegrationEvent
	{
