...
namespace Synapse.Integration.Events.WorkflowInstances
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the execution of a V1WorkflowInstance has been suspended
	/// </summary>
	[DataContract]
	public partial class V1WorkflowInstanceSuspendedIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The logs associated to the suspended V1WorkflowInstance's execution
		/// </summary>
		[DataMember(Name = "Logs", Order = 3)]
		[Description("The logs associated to the suspended V1WorkflowInstance's execution")]
