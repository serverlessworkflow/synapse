...
namespace Synapse.Integration.Events.FunctionDefinitionCollections
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a new V1FunctionDefinitionCollection has been created
	/// </summary>
	[DataContract]
	public partial class V1FunctionDefinitionCollectionCreatedIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// </summary>
		[DataMember(Name = "Functions", Order = 6)]
