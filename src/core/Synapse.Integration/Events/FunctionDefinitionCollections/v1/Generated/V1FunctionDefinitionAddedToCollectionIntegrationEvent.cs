...
namespace Synapse.Integration.Events.FunctionDefinitionCollections
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the description of a V1FunctionDefinitionCollection has changed
	/// </summary>
	[DataContract]
	public partial class V1FunctionDefinitionAddedToCollectionIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The newly added FunctionDefinition
		/// </summary>
		[DataMember(Name = "Function", Order = 3)]
		[Description("The newly added FunctionDefinition")]
		public virtual FunctionDefinition Function { get; set; }
