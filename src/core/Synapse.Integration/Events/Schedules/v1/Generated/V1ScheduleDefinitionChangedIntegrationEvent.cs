...
namespace Synapse.Integration.Events.Schedules
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever the ScheduleDefinition of a V1Schedule has changed
	/// </summary>
	[DataContract]
	public partial class V1ScheduleDefinitionChangedIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The V1Schedule's updated ScheduleDefinition
		/// </summary>
		[DataMember(Name = "Definition", Order = 3)]
		[Description("The V1Schedule's updated ScheduleDefinition")]
