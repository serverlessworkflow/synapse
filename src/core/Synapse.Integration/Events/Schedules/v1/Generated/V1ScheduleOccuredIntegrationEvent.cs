...
namespace Synapse.Integration.Events.Schedules
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a V1Schedule has occured
	/// </summary>
	[DataContract]
	public partial class V1ScheduleOccuredIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The id of the V1WorkflowInstance that has been created as the result of the V1Schedule's occurence
		/// </summary>
		[DataMember(Name = "WorkflowInstanceId", Order = 3)]
		[Description("The id of the V1WorkflowInstance that has been created as the result of the V1Schedule's occurence")]
