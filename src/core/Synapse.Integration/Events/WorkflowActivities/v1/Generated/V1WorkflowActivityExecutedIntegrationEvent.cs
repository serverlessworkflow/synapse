...
namespace Synapse.Integration.Events.WorkflowActivities
{
		...
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The V1WorkflowActivityStatus of the V1WorkflowActivity when it finished executing
		/// </summary>
		[DataMember(Name = "Status", Order = 3)]
		[Description("The V1WorkflowActivityStatus of the V1WorkflowActivity when it finished executing")]
		public virtual V1WorkflowActivityStatus Status { get; set; }

		/// <summary>
		/// The V1WorkflowActivity's error, if any
		/// </summary>
		[DataMember(Name = "Error", Order = 4)]
		[Description("The V1WorkflowActivity's error, if any")]
		public virtual Error Error { get; set; }

		/// <summary>
		/// The V1WorkflowActivity's output, if any
		/// </summary>
