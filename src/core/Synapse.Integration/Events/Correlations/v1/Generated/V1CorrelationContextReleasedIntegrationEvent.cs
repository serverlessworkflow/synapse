...
namespace Synapse.Integration.Events.Correlations
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a V1CorrelationContext has been released by a V1Correlation
	/// </summary>
	[DataContract]
	public partial class V1CorrelationContextReleasedIntegrationEvent
		: V1IntegrationEvent
	{
