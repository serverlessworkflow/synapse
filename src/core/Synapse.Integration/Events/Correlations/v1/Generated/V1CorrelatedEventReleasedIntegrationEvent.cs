...
namespace Synapse.Integration.Events.Correlations
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a V1Event has been released by a V1Correlation
	/// </summary>
	[DataContract]
	public partial class V1CorrelatedEventReleasedIntegrationEvent
		: V1IntegrationEvent
	{
		...
		/// <summary>
		/// The id of the V1CorrelationContext the V1Event has been released from
		/// </summary>
		[DataMember(Name = "ContextId", Order = 3)]
		[Description("The id of the V1CorrelationContext the V1Event has been released from")]
		public virtual string ContextId { get; set; }

		/// <summary>
		/// The id of the V1Event that has been released
		/// </summary>
		[DataMember(Name = "EventId", Order = 4)]
		[Description("The id of the V1Event that has been released")]
