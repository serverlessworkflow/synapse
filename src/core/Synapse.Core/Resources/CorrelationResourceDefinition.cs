...
/// <summary>
/// Represents the definition of an <see cref="Correlation"/> <see cref="Resource"/>
/// </summary>
[DataContract]
public record CorrelationResourceDefinition
    : ResourceDefinition
{
    ...
    static CorrelationResourceDefinition()
    {
        using var stream = typeof(Workflow).Assembly.GetManifestResourceStream($"{typeof(Correlation).Namespace}.{nameof(Correlation)}.yaml")!;
    ...
    /// <summary>
    /// Initializes a new <see cref="CorrelationResourceDefinition"/>
    /// </summary>
    public CorrelationResourceDefinition() : base(Instance) { }
