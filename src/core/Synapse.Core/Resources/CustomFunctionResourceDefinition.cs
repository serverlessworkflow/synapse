...
/// <summary>
/// Represents the definition of a <see cref="CustomFunction"/> <see cref="Resource"/>
/// </summary>
[DataContract]
public record CustomFunctionResourceDefinition
    : ResourceDefinition
{
    ...
    static CustomFunctionResourceDefinition()
    {
        using var stream = typeof(Workflow).Assembly.GetManifestResourceStream($"{typeof(CustomFunction).Namespace}.{nameof(CustomFunction)}.yaml")!;
    ...
    /// <summary>
    /// Initializes a new <see cref="CustomFunctionResourceDefinition"/>
    /// </summary>
    public CustomFunctionResourceDefinition() : base(Instance) { }
