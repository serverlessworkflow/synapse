...
/// <summary>
/// Represents the definition of an <see cref="ServiceAccount"/> <see cref="Resource"/>
/// </summary>
[DataContract]
public record ServiceAccountResourceDefinition
    : ResourceDefinition
{
    ...
    static ServiceAccountResourceDefinition()
    {
        using var stream = typeof(Workflow).Assembly.GetManifestResourceStream($"{typeof(ServiceAccount).Namespace}.{nameof(ServiceAccount)}.yaml")!;
    ...
    /// <summary>
    /// Initializes a new <see cref="ServiceAccountResourceDefinition"/>
    /// </summary>
    public ServiceAccountResourceDefinition() : base(Instance) { }
