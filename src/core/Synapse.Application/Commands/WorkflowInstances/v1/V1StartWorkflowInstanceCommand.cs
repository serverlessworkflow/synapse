...
namespace Synapse.Application.Commands.WorkflowInstances
{
        ...
        ICommandHandler<V1StartWorkflowInstanceCommand, Integration.Models.V1WorkflowInstance>
    {
        ...
        public V1StartWorkflowInstanceCommandHandler(ILoggerFactory loggerFactory, IMediator mediator, IMapper mapper, IRepository<V1WorkflowInstance> workflowInstances, IWorkflowRuntime runtimeHost)
