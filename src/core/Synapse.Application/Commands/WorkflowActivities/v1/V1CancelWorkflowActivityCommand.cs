...
namespace Synapse.Application.Commands.WorkflowActivities
{
    ...
    /// </summary>
    [DataTransferObjectType(typeof(V1CancelWorkflowActivityCommandDto))]
    ...
    public class V1CancelWorkflowActivityCommandHandler
        : CommandHandlerBase,
        ICommandHandler<V1CancelWorkflowActivityCommand, V1WorkflowActivityDto>
    {
        ...
        /// <inheritdoc/>
        public virtual async Task<IOperationResult<V1WorkflowActivityDto>> HandleAsync(V1CancelWorkflowActivityCommand command, CancellationToken cancellationToken = default)
        {
