...
${
    ...
    string GetOutputFilename(string templateType, File file)
    {
        ...
        string relativeDirectoryPath = System.IO.Path.Combine("Models", directory.Parent.Name, directory.Name, "Generated");
        string absoluteDirectoryPath = System.IO.Path.Combine(srcDirectory.FullName, "core", "Synapse.Sdk", relativeDirectoryPath);
    ...
    string NamespaceDeclaration(Class c)
    {
        ...
        output.AppendLine($"namespace Synapse.Sdk.Models");
        output.AppendLine("{");
