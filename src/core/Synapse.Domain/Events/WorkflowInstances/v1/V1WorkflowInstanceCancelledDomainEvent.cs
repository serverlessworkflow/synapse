...
{
    /// <summary>
    /// Represents the <see cref="IDomainEvent"/> fired whenever the execution of a <see cref="V1WorkflowInstance"/> has been cancelled
    /// </summary>
    [DataTransferObjectType(typeof(V1WorkflowInstanceCancelledIntegrationEvent))]
    public class V1WorkflowInstanceCancelledDomainEvent
