...
{
    /// <summary>
    /// Represents the <see cref="IDomainEvent"/> fired whenever the execution of a <see cref="V1WorkflowInstance"/> completes
    /// </summary>
    [DataTransferObjectType(typeof(V1WorkflowInstanceCompletedIntegrationEvent))]
    public class V1WorkflowInstanceCompletedDomainEvent
        : DomainEvent<Models.V1WorkflowInstance, string>
    {

        /// <summary>
        /// Initializes a new <see cref="V1WorkflowInstanceCompletedDomainEvent"/>
        /// </summary>
