...
{
    /// <summary>
    /// Defines extensions for <see cref="EventStateTriggerDefinition"/>s
    /// </summary>
    public static class EventStateTriggerDefinitionExtensions
    {

        /// <summary>
        /// Gets the <see cref="ActionDefinition"/> with the specified name
        /// </summary>
        /// <param name="branch">The <see cref="EventStateTriggerDefinition"/> to search for the specified <see cref="ActionDefinition"/></param>
        ...
        public static ActionDefinition GetAction(this EventStateTriggerDefinition branch, string name)
        {
        ...
        public static bool TryGetAction(this EventStateTriggerDefinition branch, string name, out ActionDefinition action)
        {
        ...
        /// </summary>
        /// <param name="branch">The <see cref="EventStateTriggerDefinition"/> to search</param>
        ...
        public static bool TryGetNextAction(this EventStateTriggerDefinition branch, string previousActionName, out ActionDefinition action)
        {
            action = null;
