...
namespace Synapse.Dashboard.Pages.Resources.Collections.Authentications
{
    ...
    /// <summary>
    /// Represents the Flux action used to initialize the <see cref="AuthenticationDefinitionCollectionEditorState"/>
    /// </summary>
    ...
    public class InitializeStateSuccessful
    {
        ...
        /// <param name="ifNotExists">A boolean indicating whether or not to initialize the state only if it does not yet exist</param>
        public InitializeStateSuccessful(AuthenticationDefinitionCollectionEditorState initialState, bool ifNotExists = true)
        {
        ...
        /// </summary>
        public AuthenticationDefinitionCollectionEditorState InitialState { get; }
    ...
    public class HandleFormBasedEditorChange
    {
        ...
        /// </summary>
        /// <param name="collection">The updated <see cref="V1AuthenticationDefinitionCollection"/></param>
        public HandleFormBasedEditorChange(V1AuthenticationDefinitionCollection collection)
        {
            this.Collection = collection ?? throw new ArgumentNullException(nameof(collection));
        }

        /// <summary>
        /// Gets the updated <see cref="V1AuthenticationDefinitionCollection"/>
        /// </summary>
    ...
    public class UpdateCollection
    {
        ...
        /// </summary>
        /// <param name="collection">The updated <see cref="V1AuthenticationDefinitionCollection"/></param>
        public UpdateCollection(V1AuthenticationDefinitionCollection collection)
        {
            this.Collection = collection ?? throw new ArgumentNullException(nameof(collection));
        }
    ...
    /// <summary>
    /// Represents the Flux action used to save the specified <see cref="V1AuthenticationDefinitionCollection"/> using the Synapse API
    /// </summary>
    public class SaveCollection
    {
        ...
        /// </summary>
        /// <param name="collection">The <see cref="V1AuthenticationDefinitionCollection"/> to save</param>
        public SaveCollection(V1AuthenticationDefinitionCollection collection)
        {
            this.Collection = collection;
        }

        /// <summary>
        /// Gets the <see cref="V1AuthenticationDefinitionCollection"/> to save
        /// </summary>
        public V1AuthenticationDefinitionCollection Collection { get; }
    ...
    /// <summary>
    /// Represents the Flux action used to notify the UI about the completion of the specified <see cref="V1AuthenticationDefinitionCollection"/>'s save
    /// </summary>
    public class CollectionSaved
    {
        ...
        /// </summary>
        /// <param name="collection">The <see cref="V1AuthenticationDefinitionCollection"/> that has been saved</param>
        public CollectionSaved(V1AuthenticationDefinitionCollection collection)
        {
            this.Collection = collection;
        }

        /// <summary>
        /// Gets the <see cref="V1AuthenticationDefinitionCollection"/> that has been saved
        /// </summary>
        public V1AuthenticationDefinitionCollection Collection { get; }
    ...
    /// <summary>
    /// Notifies the UI about the failure of a <see cref="V1AuthenticationDefinitionCollection"/>'s save
    /// </summary>
    public class CollectionSaveFailed
    {
        ...
        /// </summary>
        /// <param name="error">The error that has occured while saving the specified <see cref="V1AuthenticationDefinitionCollection"/></param>
        ...
        /// <summary>
        /// Gets the error that has occured while saving the specified <see cref="V1AuthenticationDefinitionCollection"/>
        /// </summary>
