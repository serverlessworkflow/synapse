...
namespace Synapse.Dashboard.Pages.Resources.Collections.Events
{
    ...
    /// </summary>
    [Feature]
    public record EventDefinitionCollectionEditorState
    {

        /// <summary>
        /// Initializes a new <see cref="EventDefinitionCollectionEditorState"/>
        /// </summary>
        public EventDefinitionCollectionEditorState()
        {
        ...
        /// </summary>
        public Integration.Models.V1EventDefinitionCollection? Collection { get; set; }
