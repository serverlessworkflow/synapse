...
namespace Synapse.Dashboard.Pages.Resources.Collections.Functions
{
    ...
    /// <summary>
    /// Represents the Flux action used to initialize the <see cref="FunctionDefinitionCollectionEditorState"/>
    /// </summary>
    public class InitializeState
    {
        ...
        /// Initializes a new <see cref="InitializeState"/>
        /// </summary>
        /// <param name="collectionId">The id of the function definition collection to initialize the state with</param>
        ...
        /// <summary>
        /// Gets/sets the id of the function definition collection to initialize the state with
        /// </summary>
    ...
    public class InitializeStateSuccessful
    {
        ...
        /// <param name="ifNotExists">A boolean indicating whether or not to initialize the state only if it does not yet exist</param>
        public InitializeStateSuccessful(FunctionDefinitionCollectionEditorState initialState, bool ifNotExists = true)
        {
        ...
        /// </summary>
        public FunctionDefinitionCollectionEditorState InitialState { get; }
    ...
    public class HandleFormBasedEditorChange
    {
        ...
        /// </summary>
        /// <param name="collection">The updated <see cref="V1FunctionDefinitionCollection"/></param>
        public HandleFormBasedEditorChange(V1FunctionDefinitionCollection collection)
        {
            this.Collection = collection ?? throw new ArgumentNullException(nameof(collection));
        }

        /// <summary>
        /// Gets the updated <see cref="V1FunctionDefinitionCollection"/>
        /// </summary>
    ...
    /// <summary>
    /// Represents the Flux action to update the edited function definition collection
    /// </summary>
    public class UpdateCollection
    {
        ...
        /// </summary>
        /// <param name="collection">The updated <see cref="V1FunctionDefinitionCollection"/></param>
        public UpdateCollection(V1FunctionDefinitionCollection collection)
        {
            this.Collection = collection ?? throw new ArgumentNullException(nameof(collection));
        }
    ...
    /// <summary>
    /// Represents the Flux action used to update the edited function definition collection
    /// </summary>
    ...
    /// <summary>
    /// Represents the Flux action used to save the specified <see cref="V1FunctionDefinitionCollection"/> using the Synapse API
    /// </summary>
    public class SaveCollection
    {
        ...
        /// </summary>
        /// <param name="collection">The <see cref="V1FunctionDefinitionCollection"/> to save</param>
        public SaveCollection(V1FunctionDefinitionCollection collection)
        {
            this.Collection = collection;
        }

        /// <summary>
        /// Gets the <see cref="V1FunctionDefinitionCollection"/> to save
        /// </summary>
        public V1FunctionDefinitionCollection Collection { get; }
    ...
    /// <summary>
    /// Represents the Flux action used to notify the UI about the completion of the specified <see cref="V1FunctionDefinitionCollection"/>'s save
    /// </summary>
    public class CollectionSaved
    {
        ...
        /// </summary>
        /// <param name="collection">The <see cref="V1FunctionDefinitionCollection"/> that has been saved</param>
        public CollectionSaved(V1FunctionDefinitionCollection collection)
        {
            this.Collection = collection;
        }

        /// <summary>
        /// Gets the <see cref="V1FunctionDefinitionCollection"/> that has been saved
        /// </summary>
        public V1FunctionDefinitionCollection Collection { get; }
    ...
    /// <summary>
    /// Notifies the UI about the failure of a <see cref="V1FunctionDefinitionCollection"/>'s save
    /// </summary>
    public class CollectionSaveFailed
    {
        ...
        /// </summary>
        /// <param name="error">The error that has occured while saving the specified <see cref="V1FunctionDefinitionCollection"/></param>
        ...
        /// <summary>
        /// Gets the error that has occured while saving the specified <see cref="V1FunctionDefinitionCollection"/>
        /// </summary>
