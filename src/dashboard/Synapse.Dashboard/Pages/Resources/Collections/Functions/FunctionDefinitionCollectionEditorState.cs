...
namespace Synapse.Dashboard.Pages.Resources.Collections.Functions
{
    ...
    /// </summary>
    [Feature]
    public record FunctionDefinitionCollectionEditorState
    {

        /// <summary>
        /// Initializes a new <see cref="FunctionDefinitionCollectionEditorState"/>
        /// </summary>
        public FunctionDefinitionCollectionEditorState()
        {
        ...
        /// </summary>
        public V1FunctionDefinitionCollection? Collection { get; set; }
