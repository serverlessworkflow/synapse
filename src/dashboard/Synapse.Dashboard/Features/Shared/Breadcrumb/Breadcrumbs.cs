...
namespace Synapse.Dashboard
{
    public static class Breadcrumbs
    {
        ...
        public static IEnumerable<IBreadcrumbItem> CreateWorkflow = new List<IBreadcrumbItem>(Workflows) { new BreadcrumbItem("New Workflow", "/workflows/new") };
        ...
        public static IEnumerable<IBreadcrumbItem> CreateFunctionDefinitionCollection = new List<IBreadcrumbItem>(FunctionDefinitionCollections) { new BreadcrumbItem("New Function Definition Collection", "/resources/collections/functions/new") };
        public static IEnumerable<IBreadcrumbItem> CreateEventDefinitionCollection = new List<IBreadcrumbItem>(EventDefinitionCollections) { new BreadcrumbItem("New Event Definition Collection", "/resources/collections/events/new") };
        public static IEnumerable<IBreadcrumbItem> CreateAuthenticationDefinitionCollection = new List<IBreadcrumbItem>(AuthenticationDefinitionCollections) { new BreadcrumbItem("New Authentication Definition Collection", "/resources/collections/authentications/new") };
