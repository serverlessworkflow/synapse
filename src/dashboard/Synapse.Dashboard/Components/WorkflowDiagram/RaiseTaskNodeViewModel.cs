    ...
    : LabeledWorkflowNodeViewModel
{
    ...
    /// </summary>
    public RaiseTaskNodeViewModel(KeyValuePair<string, RaiseTaskDefinition> task)
        : base(task.Key, "raise-task-node", null, Constants.NodeHeight * 1.5, Constants.NodeHeight * 1.5)
    {
