    ...
    where TResource : Resource, new()
{
    ...
    {
        this._definition = await this.ApiClient.ManageCluster<TResource>().GetDefinitionAsync().ConfigureAwait(false);
    ...
    public virtual async Task ListResourcesAsync()
    {
        ...
        this._resources = new EquatableList<TResource>(await (await this.ApiClient.ManageCluster<TResource>().ListAsync().ConfigureAwait(false)).ToListAsync().ConfigureAwait(false));
        this.Reduce(s => s with
        {
